...
// If value is empty, it means the ID will be generated by infrastructure
func NewID(value string) (ID, error) {
	// Allow empty value for infrastructure-generated IDs
	if value == "" {
		return ID{value: ""}, nil
	}

	// Basic validation for non-empty IDs
	if len(value) > 100 {
